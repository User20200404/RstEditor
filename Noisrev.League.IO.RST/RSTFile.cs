...
namespace Noisrev.League.IO.RST
{
    ...
    public class RSTFile : IEquatable<RSTFile>
    {
        ...
        /// <summary>
        /// Get current RST File Data in byte[].
        /// </summary>
        public byte[] RSTDataInBytes { get { return GetBytesBuffer(); } }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RSTFile"/> class and read content from the <paramref name="loadedBytes"/>.
        /// </summary>
        /// <param name="loadedBytes">bytes data of loaded RST file.</param>
        /// <exception cref="ArgumentException"/>
        /// <exception cref="ArgumentNullException"/>
        /// <exception cref="InvalidDataException"/>
        public RSTFile(byte[] loadedBytes):this()
        {
            //Read all bytes from the stream and create a reader
            var bytesReader = BytesReader.Create(loadedBytes, Encoding.UTF8);
        ...
        /// <exception cref="ArgumentNullException"/>
        /// <exception cref="InvalidDataException"/>
        public RSTFile(Stream inputStream, bool leaveOpen):this(inputStream.ReadToEnd())
        {
        ...
        public void Write(Stream outputStream, bool leaveOpen)
        {
            ...
            outputStream.Write(RSTDataInBytes, 0, RSTDataInBytes.Length);
        ...
        private byte[] GetBytesBuffer()
        {
            ...
            byte[] bytes = new byte[bytesWriter.Length + dataWriter.Length];
            Array.Copy(bytesWriter.Buffer, bytes, bytesWriter.Length);
            Array.Copy(dataWriter.Buffer, 0, bytes, bytesWriter.Length, dataWriter.Length);
            return bytes;
        }
